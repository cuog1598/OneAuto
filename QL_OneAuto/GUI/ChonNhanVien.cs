...
{
    public partial class ChonNhanVien : DevExpress.XtraEditors.XtraForm
    {
        public string ID_Choose=null;
        public ChonNhanVien()
        {
            InitializeComponent();
            gridControl1.DataSource = HoaDonDAO.Instance.Load();
            textBox1.DataBindings.Add("text", gridControl1.DataSource, "MaNV");
        ...
        private void ChonNhanVien_Load(object sender, EventArgs e)
        {
